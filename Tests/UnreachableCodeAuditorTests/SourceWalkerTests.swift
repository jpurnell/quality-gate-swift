...
struct SourceWalkerTests {
    ...
    func walksRecursively() throws {
        let root = try makeTree(["a.swift", "Sub/b.swift", "Deep/Nested/c.swift", "ignore.txt"])
    ...
    func skipsXcodeContainers() throws {
        let root = try makeTree([
            "App.swift",
    ...
    func honorsExcludes() throws {
        let root = try makeTree(["a.swift", "Generated/b.swift"])
        defer { try? FileManager.default.removeItem(at: root) }
